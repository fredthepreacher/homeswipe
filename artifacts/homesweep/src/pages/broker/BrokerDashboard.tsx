  ...
  return (
    <div className="min-h-screen flex flex-col bg-background pb-24 overflow-y-auto">
      <header className="px-5 pt-7 pb-5 bg-card border-b border-border/40">
        ...
        <h1 className="text-2xl font-bold">{user?.name ?? "Agent"} 👋</h1>
      ...
      <main className="flex-1 px-5 pt-5 space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-2.5">
            ...
            <button onClick={() => navigate("/broker/listings")} className="text-xs text-primary font-semibold hover:underline flex items-center gap-0.5">
        ...
        {inquiries.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-2.5">
              ...
              <button onClick={() => navigate("/broker/inquiries")} className="text-xs text-primary font-semibold hover:underline flex items-center gap-0.5">
                See all <ChevronRight className="w-3 h-3" />
              </button>
            </div>
            <div className="space-y-2">
