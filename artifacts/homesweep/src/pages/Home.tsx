...
export default function Home() {
  ...
  // Shared drag x — card writes to this, buttons read from it
  const dragX = useMotionValue(0);

  // Reject button: grows + glows red when swiping left
  ...
  // Save button: grows + glows green when swiping right
  ...
  return (
    <div className="h-screen w-full bg-background overflow-hidden flex flex-col">
      ...
      {/* Action Buttons — react to drag position */}
      {!isExhausted && (
